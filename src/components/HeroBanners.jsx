...
export default function HeroBanners() {
  return (
    <div className="flex gap-3 h-full overflow-x-auto scrollbar-hide snap-x snap-mandatory pb-1" data-no-swipe>
      {BANNERS.map((banner) => (
        <Link key={banner.title} to="/tournaments" className="group relative shrink-0 w-[88%] sm:w-[68%] xl:w-[62%] min-h-[172px] sm:min-h-[220px] overflow-hidden rounded-xl border border-white/15 bg-card hover:border-lime/50 transition snap-start">
