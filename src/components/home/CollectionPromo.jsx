...
// Homepage feature highlight for "My Collection" — set completion vault.
    ...
    <Link to="/collection" className="group block relative overflow-hidden rounded-2xl border border-lime/30 bg-gradient-to-r from-[#14160c] to-[#0c0c0c] p-4 sm:p-5">
      ...
      <div className="relative flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <span className="text-[10px] font-black tracking-widest uppercase text-lime">New feature</span>
          <h3 className="text-base sm:text-lg font-black text-white leading-tight">My Collection</h3>
          <p className="text-xs text-white/50 mt-0.5">Complete thematic sets, discover missing cards and track your vault.</p>
        </div>
