...
export default function GameCard({ game }) {
  ...
  return (
    <Link to={`/game/${game.slug}`} className="group relative block aspect-[9/6] sm:aspect-[1.04/1] rounded-xl overflow-hidden bg-card border border-white/15 hover:border-lime/60 active:scale-[0.98] transition">
      {isSlot && game.image ? (
