    ...
    <>
      ...
      >
        ...
        <div className="absolute bottom-4 left-3 right-3">
          <div className="rounded-lg border border-lime/10 bg-lime/5 p-3">
            <div className="mb-1 flex items-center gap-2">
              <Star className="h-3.5 w-3.5 text-lime" />
              <span className="text-xs font-semibold text-lime">VIP Level 3</span>
            </div>
            <div className="h-1.5 overflow-hidden rounded-full bg-secondary">
              <div className="h-full w-[45%] rounded-full bg-lime" />
            </div>
          </div>
        </div>
      </aside>
